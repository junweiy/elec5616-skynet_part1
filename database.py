...
def check_login(member_id):
    ...
    user_data = ['1', 'firstName', 'lastName']
...
def all_issue():
    ...
    # ]
    issue_db = [
        ['Division by zero', '1', '1', '1', 'Division by 0 doesn\'t yield error or infinity as would be expected. Instead it results in -1.'],
        ['Factorial with addition anomaly', '1', '1', '1', 'No description']
    ]
